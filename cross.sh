...
cd binutils-build
../binutils-2.39/configure --target=$TARGET --with-sysroot --enable-interwork --enable-multilib --disable-nls --disable-werror --prefix=$PREFIX 2>&1 | tee configure.log
